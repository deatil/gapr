...
var curves = []struct {
...
}{
    {
        ...
        Params:  &elliptic.CurveParams{
            ...
            B:       bigFromHex("1fffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffa4331"),
...
import (
    ...
    "github.com/deatil/gapr/e521/fiat"
)
...
func (table *{{.p}}Table) Select(p *{{.P}}Point, n uint8) {
    if n >= 16 {
        panic("e521: internal error: {{.p}}Table called with out-of-bounds value")
    }
    p.Set(New{{.P}}Point())
...
func bigFromHex(s string) *big.Int {
    ...
    if !ok {
        panic("e521/elliptic: internal error: invalid encoding")
    }
    return b
}
