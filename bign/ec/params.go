...
type p256Curve struct {
	newPoint func() *bign.P256Element
...
func (curve *p256Curve) pointFromAffine(x, y *big.Int) (p *bign.P256Element, err error) {
...
func (curve *p256Curve) pointToAffine(p *bign.P256Element) (x, y *big.Int) {
	out := p.Bytes()
...
func (curve *p256Curve) Add(x1, y1, x2, y2 *big.Int) (*big.Int, *big.Int) {
	...
	if err != nil {
		panic("bign/elliptic: Add was called on an invalid point")
	}
...
func (curve *p256Curve) Double(x1, y1 *big.Int) (*big.Int, *big.Int) {
	...
	if err != nil {
		panic("bign/elliptic: Double was called on an invalid point")
	}
...
func (curve *p256Curve) ScalarMult(Bx, By *big.Int, scalar []byte) (*big.Int, *big.Int) {
	...
	if err != nil {
		panic("bign/elliptic: ScalarMult was called on an invalid point")
	}
	scalar = curve.normalizeScalar(scalar)
	p, err = p.ScalarMult(p, scalar)
	if err != nil {
		panic("bign/elliptic: bign rejected normalized scalar")
	}
...
func (curve *p256Curve) CombinedMult(Px, Py *big.Int, s1, s2 []byte) (x, y *big.Int) {
	...
	if err != nil {
		panic("bign/elliptic: CombinedMult was called on an invalid point")
	}
...
func (curve *p256Curve) Inverse(k *big.Int) *big.Int {
	...
	inverse, err := bign.P256OrdInverse(scalar)
	if err != nil {
		panic("bign/elliptic: bign rejected normalized scalar")
	}
