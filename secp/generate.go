...
var curves = []struct {
    ...
    {
        P:         "P112r1",
        Element:   "fiat.P112r1Element",
        Params:    &elliptic.CurveParams{
            Name:    "secp112r1",
            BitSize: 112,
            P:       bigFromHex("DB7C2ABF62E35E668076BEAD208B"),
            N:       bigFromHex("DB7C2ABF62E35E7628DFAC6561C5"),
            B:       bigFromHex("659EF8BA043916EEDE8911702B22"),
            Gx:      bigFromHex("09487239995A5EE76B55F9C2F098"),
            Gy:      bigFromHex("A89CE5AF8724C0A23E0E0FF77500"),
        },
    },
    {
        P:       "P112r2",
        Element: "fiat.P112r2Element",
        Params:  &elliptic.CurveParams{
            Name:    "secp112r2",
            BitSize: 112,
            P:       bigFromHex("DB7C2ABF62E35E668076BEAD208B"),
            N:       bigFromHex("36DF0AAFD8B8D7597CA10520D04B"),
            B:       bigFromHex("51DEF1815DB5ED74FCC34C85D709"),
            Gx:      bigFromHex("4BA30AB5E892B4E1649DD0928643"),
            Gy:      bigFromHex("ADCD46F5882E3747DEF36E956E97"),
        },
    },
    {
        P:       "P128r1",
        Element: "fiat.P128r1Element",
        Params:  &elliptic.CurveParams{
            Name:    "secp128r1",
            BitSize: 128,
            P:       bigFromHex("FFFFFFFDFFFFFFFFFFFFFFFFFFFFFFFF"),
            N:       bigFromHex("FFFFFFFE0000000075A30D1B9038A115"),
            B:       bigFromHex("E87579C11079F43DD824993C2CEE5ED3"),
            Gx:      bigFromHex("161FF7528B899B2D0C28607CA52C5B86"),
            Gy:      bigFromHex("CF5AC8395BAFEB13C02DA292DDED7A83"),
        },
    },
    {
        P:       "P128r2",
        Element: "fiat.P128r2Element",
        Params:  &elliptic.CurveParams{
            Name:    "secp128r2",
            BitSize: 128,
            P:       bigFromHex("FFFFFFFDFFFFFFFFFFFFFFFFFFFFFFFF"),
            N:       bigFromHex("3FFFFFFF7FFFFFFFBE0024720613B5A3"),
            B:       bigFromHex("5EEEFCA380D02919DC2C6558BB6D8A5D"),
            Gx:      bigFromHex("7B6AA5D85E572983E6FB32A7CDEBC140"),
            Gy:      bigFromHex("27B6916A894D3AEE7106FE805FC34B44"),
        },
    },
}
...
import (
    ...
    "github.com/deatil/gapr/secp/fiat"
)
